...
* @param services An array of DDXMLElements in the form shown below. You will need to extract the data you
*                 wish to use.
*
...
*
* @param sender XMPPMUC object invoking this delegate method.
* @param rooms An array of DDXMLElements in the form shown below. You will need to extract the data you
*              wish to use.
*
