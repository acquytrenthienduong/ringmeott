...
- (void)retrieveMessageArchiveWithFields:(nullable NSArray<DDXMLElement*> *)fields
                           withResultSet:(nullable XMPPResultSet *)resultSet;

- (void)retrieveMessageArchiveAt:(nullable XMPPJID *)archiveJID
                      withFields:(nullable NSArray<DDXMLElement*> *)fields
                   withResultSet:(nullable XMPPResultSet *)resultSet;

- (void)retrieveFormFields;

+ (DDXMLElement *)fieldWithVar:(NSString *)var
