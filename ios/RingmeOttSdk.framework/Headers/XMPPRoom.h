...
**/
- (void)joinRoomUsingNickname:(NSString *)desiredNickname history:(DDXMLElement *)history;
- (void)joinRoomUsingNickname:(NSString *)desiredNickname history:(DDXMLElement *)history password:(NSString *)passwd;
...
**/
- (void)configureRoomUsingOptions:(DDXMLElement *)roomConfigForm;
...
+ (DDXMLElement *)itemWithAffiliation:(NSString *)affiliation jid:(XMPPJID *)jid;
+ (DDXMLElement *)itemWithRole:(NSString *)role jid:(XMPPJID *)jid;
