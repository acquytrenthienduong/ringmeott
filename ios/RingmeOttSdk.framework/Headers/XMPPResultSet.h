 ...
 * It extends DDXMLElement.
 *
 * Calling resultSet on an DDXMLElement returns an XMPPResultSet if it exists (see DDXMLElement+XEP_0059.h)
 *
...
/**
 * Converts an DDXMLElement to an XMPPResultSet element in place (no memory allocations or copying)
 **/
+ (XMPPResultSet *)resultSetFromElement:(DDXMLElement *)element;
