...
**/
@property (readwrite, strong) DDXMLElement *pushConfiguration;
...
+ (DDXMLElement *)pushConfigurationContainer;

+ (DDXMLElement *)keepaliveWithMax:(NSTimeInterval)max;
+ (DDXMLElement *)sessionWithDuration:(NSTimeInterval)duration;
+ (DDXMLElement *)statusWithType:(NSString *)type message:(NSString *)message;
