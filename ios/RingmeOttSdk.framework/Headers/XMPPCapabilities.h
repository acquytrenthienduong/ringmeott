...
@interface XMPPCapabilities : XMPPModule
{
	...
	DDXMLElement *myCapabilitiesQuery; // Full list of capabilites <query/>
	DDXMLElement *myCapabilitiesC;     // Hashed element <c/>
 ...
 * Otherwise it will match the given jid from any stream this storage instance is managing.
**/
- (DDXMLElement *)capabilitiesForJID:(XMPPJID *)jid xmppStream:(XMPPStream *)stream;
 ...
 * Otherwise it will match the given jid from any stream this storage instance is managing.
**/
- (DDXMLElement *)capabilitiesForJID:(XMPPJID *)jid ext:(NSString **)extPtr xmppStream:(XMPPStream *)stream;
...
- (BOOL)setCapabilitiesNode:(NSString *)node
      ...
      andGetNewCapabilities:(DDXMLElement **)newCapabilitiesPtr;
...
**/
- (void)setCapabilities:(DDXMLElement *)caps forHash:(NSString *)hash algorithm:(NSString *)hashAlg;
...
**/
- (void)setCapabilities:(DDXMLElement *)caps forJID:(XMPPJID *)jid xmppStream:(XMPPStream *)stream;
...
**/
- (void)xmppCapabilities:(XMPPCapabilities *)sender collectingMyCapabilities:(DDXMLElement *)query;
...
**/
- (void)xmppCapabilities:(XMPPCapabilities *)sender didDiscoverCapabilities:(DDXMLElement *)caps forJID:(XMPPJID *)jid;
