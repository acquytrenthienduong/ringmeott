 ...
 * 
 * The result is an array or privacy items (DDXMLElement's).
 ...
 * The given array should contain only privacy items (DDXMLElement's).
 * 
...
**/
+ (DDXMLElement *)privacyItemWithAction:(NSString *)action order:(NSUInteger)order;
+ (DDXMLElement *)privacyItemWithType:(NSString *)type
                                value:(NSString *)value
                               action:(NSString *)action
                                order:(NSUInteger)order;

+ (void)blockIQs:(DDXMLElement *)privacyItem;
+ (void)blockMessages:(DDXMLElement *)privacyItem;
+ (void)blockPresenceIn:(DDXMLElement *)privacyItem;
+ (void)blockPresenceOut:(DDXMLElement *)privacyItem;
