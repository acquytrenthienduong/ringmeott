...
**/
- (NSString *)publishToNode:(NSString *)node entry:(DDXMLElement *)entry;
- (NSString *)publishToNode:(NSString *)node entry:(DDXMLElement *)entry withItemID:(NSString *)itemId;
- (NSString *)publishToNode:(NSString *)node
                      entry:(DDXMLElement *)entry
