...
- (BOOL)authenticateWithPassword:(NSString *)password loginMechanism:(NSString *)loginMechanism authType:(NSString *)authType error:(NSError **)errPtr;
...
**/
- (void)sendElement:(DDXMLElement *)element;
...
**/
- (void)sendElement:(DDXMLElement *)element andGetReceipt:(XMPPElementReceipt **)receiptPtr;
...
@optional
- (void)xmppStream:(XMPPStream *)sender log:(NSString *)value;
