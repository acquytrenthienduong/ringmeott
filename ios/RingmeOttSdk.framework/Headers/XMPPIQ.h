 ...
 * It extends XMPPElement, which in turn extends DDXMLElement.
...
/**
 * Converts an DDXMLElement to an XMPPIQ element in place (no memory allocations or copying)
**/
+ (XMPPIQ *)iqFromElement:(DDXMLElement *)element;
...
+ (XMPPIQ *)iqWithType:(NSString *)type to:(XMPPJID *)jid elementID:(NSString *)eid child:(DDXMLElement *)childElement;
+ (XMPPIQ *)iqWithType:(NSString *)type elementID:(NSString *)eid;
+ (XMPPIQ *)iqWithType:(NSString *)type elementID:(NSString *)eid child:(DDXMLElement *)childElement;
+ (XMPPIQ *)iqWithType:(NSString *)type child:(DDXMLElement *)childElement;
...
- (id)initWithType:(NSString *)type to:(XMPPJID *)jid elementID:(NSString *)eid child:(DDXMLElement *)childElement;
- (id)initWithType:(NSString *)type elementID:(NSString *)eid;
- (id)initWithType:(NSString *)type elementID:(NSString *)eid child:(DDXMLElement *)childElement;
- (id)initWithType:(NSString *)type child:(DDXMLElement *)childElement;
...
**/
- (DDXMLElement *)childElement;
- (DDXMLElement *)childErrorElement;
